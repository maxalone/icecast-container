...
export ICECAST_HOSTNAME=acast.tangram.page
export ICECAST_ADMIN_PASSWORD=
export ICECAST_ADMIN_USERNAME=
export ICECAST_MAX_CLIENTS=100
export ICECAST_MAX_SOURCES=3
export ICECAST_ADMIN_EMAIL=info@tangram.page
...
sed -i "s/<logdir>[^<]*<\/logdir>/<logdir>/var/log/icecast<\/logdir>/g" /etc/icecast.xml
